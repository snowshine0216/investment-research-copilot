...
|-----|------|-------|------|--------|------|-------|----|--------|--------|-----------|-----|-------|
| 001 | ✅   | ⏭️   | ✅   | ✅ claude/valuation-grounding-001 | ✅ dd13a43 | ✅    | ✅ #101 | 🔄     | ✅ inline | 🔄        | 🔄  | ⏳    |
...
- **001-fix** 🔄 — round 1 applied 4 ship-review fixes (`0a4f722 9de68c1 1ced924 118e1c6`) + the R3-regression catch (retire obsolete locks). Awaiting verify + pr-review verdicts to confirm loop-exit.
