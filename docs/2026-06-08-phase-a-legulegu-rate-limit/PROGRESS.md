...
- 2026-06-08 — fix ✅ **1 round** (`0c1f2dc`): applied P1-A (live-sweep `LeguleguCooldownExhausted` clean-stop guard) + P1-B (PB-axis caplog assertion — `"pb"` + `"cache preserved"`). Re-verified: only 2 test files changed, src/ untouched, **88 passed / 5 skipped**, ruff clean. All 3 post-ship verdicts PASS/PASS-WITH-NITS with nits now resolved. merge 🔄 next.
